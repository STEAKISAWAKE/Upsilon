...
void VulkanGraphicsPipeline::Initalize()
{
    ...
    {
        ULogError("Vulkan Graphics Pipeline", "Could not create graphics pipeline layout!");
    }
    ...
    {
        ULogError("Vulkan Graphics Pipeline", "Could not create graphics pipeline!");
    }
}
